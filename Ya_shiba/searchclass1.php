...
$output1 = '';
$sql = "SELECT * FROM enrolled_classroom WHERE USER_ID ='{$_SESSION['id']}'";
$result1 = mysqli_query($connection, $sql);
while ($row1 = mysqli_fetch_assoc($result1)) {
    $class_id = $row1['CLASSROOM_ID'];
    $sql2 = "SELECT * FROM classroom WHERE CLASSROOM_ID=$class_id AND CLASS_NAME LIKE '%" . $_POST['name'] . "%'";
