            ...
            <div id="layoutSidenav_content" class="bg-light">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                            $query = "SELECT yashiba_user.USERNAME,yashiba_user.USER_PROFILE,yashiba_user.USER_NAME, yashiba_user.EMAIL, yashiba_user.CONTACT_NUMBER, yashiba_user.PASSWORD
                            FROM yashiba_user 
