...
<!-- Program Name : Report-->
<!-- Description: Teacher able to report the difficulty faced when using the systen -->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="r_title" require>
                        </div>
                            <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Report Description</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="r_message" require></textarea>
                        </div>
