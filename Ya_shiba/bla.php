<?php
    ...
    if (isset($_POST['edittxt'])) {
        ...
        echo '<script>window.location.href = "bla.php";</script>';
...
<title>Student Account - Admin</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <td style="text-align:center;white-space:nowrap;">
            <a type="submit" class="edit-button" value="<?php echo $row['USER_ID'];?>" name="edittxt"  onclick="alert('Student  has been deleted.')">
            ...
            <a href="a_delete.php?stuID=<?php echo $row['USER_ID'];?>" onclick="alert('Student Account has been deleted.')">
                ...
                <button type="submit" class="edit-button"  value="<?php echo $row['USER_ID'];?>" name="edittxt">
                <i class="fa-solid fa-pen me-2" style="color: #404a69;width:25px;height:25px;"></i>
                </button>    
            </td>
        </form>
